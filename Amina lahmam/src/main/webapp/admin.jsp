                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    <img src="assets/images/logo livrelahmam.jpg" class="img-radius" alt="User-Profile-Image">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="assets/images/logo livrelahmam.jpg" alt="User-Profile-Image">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Bienvenue dans votre espace Gestion des livres</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="inscription" method="post">
                                                            <div class="form-group row">
                                                             ...
                                                             <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Votre Prenom</label>
                                                                <div class="col-sm-10">
                                                             ...
                                                             <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Adressa Mail</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                          	  <div class="col-sm-10">
                                                          			<button type="submit" class="btn waves-effect waves-light btn-inverse"><i class="icofont icofont-user-alt-3"></i>Ajouter Votre Etudiant</button>
                                                                </div></div>                               
                                                         </form>  
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="livre" method="post">
                                                            <div class="form-group row">
                                                             ...
                                                             <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Année Edition</label>
                                                                <div class="col-sm-10">
