                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="authentification" method="post">
                            <div class="text-center">
                                <img src="assets/images/amina livre.jpg" alt="amina livre.jpg">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">S'identifier</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <p class="text-inverse text-left"><a href="index.html"><b>Copyright 2021 / Amina lahmam</b></a></p>
                                        </div>
                                        <div class="col-md-2">
